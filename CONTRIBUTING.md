...
In your browser, navigate to: [https://github.com/okta/samples-java-spring-mvc](https://github.com/okta/samples-java-spring-mvc)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/samples-java-spring-mvc.git
$ cd samples-java-spring-mvc
$ git remote add upstream https://github.com/okta/samples-java-spring-mvc.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/samples-java-spring-mvc](https://github.com/YOUR_ACCOUNT/samples-java-spring-mvc)
